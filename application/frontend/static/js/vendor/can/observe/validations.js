...
//  proc should return true if there's an error or the error message
    ...
    can.each([ can.Observe, can.Model ], function (clss) {
        ...
        can.extend(clss, {
             ...
             * @parent can.Observe.validations
             *
             * `validationMessages` has the default validate error messages that will be returned by the builtin
             * validate methods. These can be overwritten by assigning new messages
             ...
             *
             * @param {Array<String>|String} attrNames Attribute name(s) to to validate
             * @param {RegExp} regexp Regular expression used to match for validate
    ...
    can.extend(can.Observe.prototype, {
        ...
        errors: function (attrs, newVal) {
            ...
            // go through each attribute or validate and
            // add any errors
