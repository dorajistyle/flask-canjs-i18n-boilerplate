...
class FlaskTestCaseMixin(object):
    ...
    def _xform_data(self, kwargs):
        kwargs['content_type'] = 'application/x-www-form-urlencoded;charset=UTF-8'
        return kwargs
    ...
    def xget(self, *args, **kwargs):
        return self._jrequest(self.client.get, *args, **self._xform_data(kwargs))

    def xpost(self, *args, **kwargs):
        return self._jrequest(self.client.post, *args, **self._xform_data(kwargs))

    def xput(self, *args, **kwargs):
        return self._jrequest(self.client.put, *args, **self._xform_data(kwargs))
